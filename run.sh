...
export APP_BASIC_WORDS_FILE='1-1000.txt'
...
docker run -it --rm -p 8080:5000 -e APP_BASIC_WORDS_FILE -e APP_DB_FILE -v ${SCRIPT_DIR}:${SCRIPT_DIR}:z -w ${SCRIPT_DIR} --name app my-python-app $@
